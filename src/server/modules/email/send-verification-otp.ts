...
function otpSubject(type: OtpEmailType) {
  switch (type) {
    case "forget-password":
      return "Reset your ArchiveCloud password";
    case "sign-in":
      return "Your ArchiveCloud sign-in code";
    case "email-verification":
      return "Verify your ArchiveCloud email";
    case "change-email":
      return "Confirm your ArchiveCloud email change";
    default:
      return "Your ArchiveCloud verification code";
  }
}
...
function otpMessage(type: OtpEmailType) {
  switch (type) {
    case "forget-password":
      return "Use this code to reset your ArchiveCloud password. It expires in 5 minutes.";
    case "sign-in":
      return "Use this code to sign in to ArchiveCloud. It expires in 5 minutes.";
    case "email-verification":
