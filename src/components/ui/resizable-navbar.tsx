...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  // Document scroll — target ref does not work reliably with `position: fixed`
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    gradient:
      "bg-gradient-to-b from-primary to-[color-mix(in_srgb,var(--primary)_85%,black)] text-primary-foreground shadow-[0_6px_14px_-8px_color-mix(in_oklch,var(--primary)_10%,transparent)]",
  };
