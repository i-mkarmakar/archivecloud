...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-border bg-background z-0 h-full max-h-100 w-full min-w-0 max-w-lg overflow-hidden rounded-xl border",
        className,
      )}
    >
      ...
      <pre className="overflow-x-auto p-4">
        <code className="grid gap-y-1 break-all whitespace-pre-wrap">
          {wrappedChildren}
        </code>
      </pre>
    </div>
