...
const CTA_LOGOS = [
  {
    ...
    className: "top-[18%] left-[6%] size-5 opacity-60 sm:size-14",
  },
  {
    src: "/brand/dropbox.svg",
    className: "top-[22%] right-[8%] size-5 opacity-[0.58] sm:size-14",
  },
  {
    src: "/brand/onedrive.svg",
    className:
      "top-[48%] left-[10%] size-5 opacity-55 sm:left-[12%] sm:size-14",
  },
  {
    src: "/brand/icloud.svg",
    className:
      "top-[46%] right-[10%] size-5 opacity-55 sm:right-[12%] sm:size-14",
  },
  {
    src: "/brand/google-photos.svg",
    className: "top-[12%] left-[28%] size-5 opacity-50 sm:size-14",
  },
  {
    src: "/brand/pcloud.svg",
    className: "top-[14%] right-[26%] size-5 opacity-50 sm:size-14",
  },
  {
    src: "/brand/google.svg",
    className: "bottom-[38%] left-[22%] size-5 opacity-50 sm:size-14",
  },
] as const;
    ...
    <section className="px-4 py-6 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
      <div className="relative mx-auto max-w-[1200px] overflow-hidden rounded-xl bg-gradient-to-b from-primary to-[color-mix(in_srgb,var(--primary)_85%,black)] px-4 pt-7 pb-12 text-center sm:rounded-[22px] sm:px-10 sm:pt-16 sm:pb-32">
        ...
        <RainbowButton
          ...
          size="lg"
          variant="outline"
          className="relative z-10 mt-4 h-9 rounded-full px-5 text-sm font-semibold shadow-[0_6px_14px_-8px_color-mix(in_oklch,var(--primary)_10%,transparent)] sm:mt-8 sm:h-12 sm:px-7 sm:text-[15px]"
        >
        ...
        <img
          ...
          alt=""
          aria-hidden
          className="pointer-events-none absolute inset-x-0 -bottom-2 z-[3] h-auto w-full max-sm:scale-y-75 max-sm:origin-bottom select-none sm:-bottom-4"
        />
      </div>
    </section>
  );
