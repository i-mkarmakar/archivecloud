    ...
    >
      {items.map((folder) => (
        ...
        >
          <button
            type="button"
            className="absolute right-2 top-2 flex h-8 w-8 items-center justify-center rounded-xl text-muted hover:bg-surface-secondary sm:right-3 sm:top-3"
            onClick={(event) => {
          ...
          <FolderVisual
            folder={folder}
            className={cn("transition group-hover:scale-110", cfg.icon)}
          />
          <h2
            className={cn(
