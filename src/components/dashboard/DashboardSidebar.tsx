...
import { type AppMode, developerNavItems, workspaceNavItems } from "./config";
...
export function DashboardSidebar({
  ...
  const breakdownItems = [
    {
      label: "Photo",
      value: formatBytes(breakdown.photo),
      dotClass: "bg-success",
    },
    {
      label: "Video",
      value: formatBytes(breakdown.video),
      dotClass: "bg-accent",
    },
    {
      label: "Document",
      value: formatBytes(breakdown.document),
      dotClass: "bg-warning",
    },
    {
      label: "Free Storage",
